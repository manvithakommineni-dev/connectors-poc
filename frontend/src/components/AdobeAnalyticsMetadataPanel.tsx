import type { AdobeAnalyticsItemDetail } from "../api/adobeanalytics";

interface Props {
  item: AdobeAnalyticsItemDetail;
}

export function AdobeAnalyticsMetadataPanel({ item }: Props) {
  ...
  return (
    <div style={{ padding: "0 4px" }}>
      <div
        style={{
          background: "linear-gradient(135deg, #EB1000 0%, #B80000 100%)",
          borderRadius: 10,
          padding: "18px 20px",
          marginBottom: 16,
          color: "#fff",
